...
export const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.67c.61 1.17 1.07 2.453 1.07 3.822v.003a9.348 9.348 0 01-2.986 6.64c-.149.125-.301.24-.455.348z" />
    </svg>
);

export const BanknotesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414-.336.75-.75.75h-.75m0-1.5h.375c.621 0 1.125.504 1.125 1.125v.375m-18 0h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v.75m18 0v9a1.5 1.5 0 01-1.5-1.5H3.75a1.5 1.5 0 01-1.5-1.5v-9m18 0h-16.5" />
    </svg>
);
...
export const SunIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.95-4.243l-1.59-1.59M3 12h2.25m.386-6.364l1.59 1.591M12 12a4.5 4.5 0 000 9 4.5 4.5 0 000-9z" />
    </svg>
);
...
export const HubspotIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.222 17.155a.575.575 0 0 1-.41.173.588.588 0 0 1-.41-.173l-2.65-2.65a.57.57 0 0 1-.172-.41v-4.595a.57.57 0 0 1 .583-.583h2.094c.321 0 .583.262.583.583v2.85l2.48 2.48a.583.583 0 0 1 0 .82zM7.227 12.56c0-.322.262-.583.583-.583h4.486a.58.58 0 0 1 .583.583v2.48l-2.65-2.65a.57.57 0 0 0-.82 0l-2.183 2.183a.583.583 0 0 1-.41.173.575.575 0 0 1-.41-.173.583.583 0 0 1 0-.82l.82-.82z" />
    </svg>
);
...
export const GoogleDriveIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M19.143 7.5H4.857L8.857 14H23.143L19.143 7.5Z" />
        <path d="M6.29 15.25L2.29 8.75L4.857 7.5L8.857 14L6.29 15.25Z" />
        <path d="M17.71 15.25L15.143 14L11.143 20.5H13.71L17.71 15.25Z" />
    </svg>
);
...
export const BitcoinIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-6h6m-6 0a9 9 0 1118 0 9 9 0 01-18 0z" />
    </svg>
);

export const BriefcaseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.972 2.4-2.215 2.521-1.243.121-2.285-1.12-2.285-2.421v-2.175a1.5 1.5 0 01.44-1.06l.16-.16a1.5 1.5 0 012.12 0l1.755 1.755a1.5 1.5 0 010 2.12l-1.606 1.606a1.5 1.5 0 01-2.203.01L14.95 18.275a1.5 1.5 0 010-2.121l.16-.16a1.5 1.5 0 011.06-.44V14.5a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25v.075M3.75 21V6.75A2.25 2.25 0 016 4.5h12A2.25 2.25 0 0120.25 6.75v2.859M3.75 21a2.25 2.25 0 002.25-2.25V6.75" />
    </svg>
);
...
export const SaveIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V8.25a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3m0 0h-3m0 0a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 3.75V16.5m18-13.5v13.5A2.25 2.25 0 0118.75 21H5.25A2.25 2.25 0 013 18.75V3.75m18 0a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 3.75m15 0v.008M9 12.75h6" />
    </svg>
);

export const FolderOpenIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 00-1.883 2.542l.857 6a2.25 2.25 0 002.227 1.932H19.05a2.25 2.25 0 002.227-1.932l.857-6a2.25 2.25 0 00-1.883-2.542m-16.5 0A2.25 2.25 0 012.25 7.5h19.5a2.25 2.25 0 012.25 2.25m-16.5 0v6c0 .621.504 1.125 1.125 1.125h14.25c.621 0 1.125-.504 1.125-1.125v-6" />
    </svg>
);
